...
class PortScannerUI(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.target_input = TextInput(multiline=False, size_hint=(None, None), height=50)  # Smaller text input box
        self.start_port_label = Label(text="Start Port:")
        self.start_port_input = TextInput(multiline=False, size_hint=(None, None), height=50)  # Smaller text input box
        self.end_port_label = Label(text="End Port:")
        self.end_port_input = TextInput(multiline=False, size_hint=(None, None), height=50)  # Smaller text input box
        ...
        self.scan_type_button_1.width = 100
        self.scan_type_button_2.size_hint = (None, None)
        self.scan_type_button_2.width = 100
        self.scan_type_button_3.size_hint = (None, None)
        self.scan_type_button_3.width = 100
        self.scan_type_button_4.size_hint = (None, None)
        self.scan_type_button_4.width = 100
